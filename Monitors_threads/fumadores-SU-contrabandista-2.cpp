...
class Estanco : public HoareMonitor
{
 ...
 int  mostrador; 	     //   Estado del mostrador: da el ingrediente que hay en el mostrador
...
void Estanco::ponerIngrediente( const int ingre )
 ...
 void Estanco::esperarRecogidaIngrediente() //el estanquero espera para poner un ingred nuevo
  {    
                       ...
                       const int i )
{
   while(true)
   {
     monitor_estanco->obtenerIngrediente( i ); //sacamos ingrediente y volvemos a dejar monitor vacío
